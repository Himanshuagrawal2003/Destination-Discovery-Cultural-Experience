      ...
      <div className="container-cq max-w-3xl">
        ...
        >
          ...
          <div className="space-y-4 text-xs text-primary-900/70 dark:text-dark-text leading-relaxed font-semibold">
            ...
            <h3 className="text-sm font-bold text-primary-900 dark:text-white font-display pt-2">Information We Collect</h3>
            <p>
            ...
            <h3 className="text-sm font-bold text-primary-900 dark:text-white font-display pt-2">How We Use Your Information</h3>
            <ul className="list-disc pl-5 space-y-1 text-primary-900/60 dark:text-dark-muted">
